...
t2w!(udp1, r#"-b --global-timeout-ms=100 udp-l:127.0.0.1:12000 mock_stream_socket:'W qqq\n|R www\n|W eee\n|R tt\n'"#,
           r#"-b --global-timeout-ms=50 udp:127.0.0.1:12000 mock_stream_socket:'R qqq\n|W www\n|R eee\n|W tt\n'"#);

t2w!(udp2, r#"-b --global-timeout-ms=100 udp-server:127.0.0.1:12001 mock_stream_socket:'W qqq\n|R www\n|W eee\n|R tt\n'"#,
           r#"-b --global-timeout-ms=50 udp:127.0.0.1:12001 mock_stream_socket:'R qqq\n|W www\n|R eee\n|W tt\n'"#);
t3w!(udp3, r#"-b --global-timeout-ms=120 udp-server:127.0.0.1:12002 mock_stream_socket:'W qqq\n|R www\n|W eee\n|R tt\n'"#,
           r#"-b --global-timeout-ms=50 udp:127.0.0.1:12002 mock_stream_socket:'R qqq\n|W www\n|R eee\n|W tt\n'"#,
           r#"-b --global-timeout-ms=50 udp:127.0.0.1:12002 mock_stream_socket:'R qqq\n|W www\n|R eee\n|W tt\n'"#);
